...
interface LindaPrescriptionProps {
  ...
  setSignatureType?: (value: 'pediatra' | 'alergolo') => void;
  allClinics?: Array<{
    clinic_id: string;
    clinic_name: string;
...
export function LindaPrescription({
  patient,
  prescription,
  setPrescription,
  doctorName,
          ...
          <div className="flex justify-center mt-4 mb-4">
            <div className="text-center">
              {showSignature ? (
                ...
                <div className="w-80 h-32 mb-2 relative border-b" style={{ borderColor: '#2F6939' }}>
                  {/* Espacio para firma */}
                </div>
              )}
          ...
          <div className="flex justify-center mt-4">
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                ...
                style={{ accentColor: '#2F6939' }}
              />
              <span className="text-sm font-medium" style={{ color: '#2F6939' }}>Firma digital</span>
            </label>
          </div>
        </div>
      </div>
